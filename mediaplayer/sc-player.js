...
(function($) {
    ...
    var opts = $.extend({}, $.scPlayer.defaults, options),
        ...
        $player.bind('onTrackDataLoaded.scPlayer', function(event) {
          ...
          $.each(tracks, function(index, track) {
            ...
            $('<li id="' + track.id+ '"><a href="' + track.permalink_url +'">' + track.title + '</a><span class="sc-track-duration">' + timecode(track.duration) + '</span></li>').data('sc-track', {id:index}).toggleClass('active', active).appendTo($list);
  ...
  $.scPlayer.loadTrackInfoAndPlay=function($elem,track){
        ...
        // add to playlist
        var $li=$('<li id="' + track.id + '"><a href="' + track.permalink_url +'">' + track.title + '</a><span class="sc-track-duration">' + timecode(track.duration) + '</span></li>')
  ...
  $.scPlayer.removeTrack=function($elem,url){
		var apiUrl = scApiUrl(url, apiKey);
		$.getJSON(apiUrl, function(data) {
			console.log(data)
			if(data.duration){
				data.permalink_url = url;
				var playerObj=players[$elem.data('sc-player').id];
				playerObj.tracks.pop(data);
				
				var $list=$(playerObj.node).find('.sc-trackslist');
				console.log($list);
				var $li=$list.find('li #'+ data.id +'');
				console.log($li);
				$li.remove();
